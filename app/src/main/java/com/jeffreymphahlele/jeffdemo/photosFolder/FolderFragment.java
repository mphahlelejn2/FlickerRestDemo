...
public class FolderFragment extends Fragment implements IFolder.View {

    public SpotsDialog loadPhotosProgressDialog;
    @Inject
    public IFolder.Presenter presenter;
    ...
    @Override
    public void sendListOfPlaces(List<Photo> groupList) {
        FolderListAdapter =new FolderListAdapter(getContext(), presenter.getSortedFoldersByOwner(groupList));
