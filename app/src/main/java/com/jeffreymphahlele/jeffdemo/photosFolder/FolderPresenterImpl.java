...
public class FolderPresenterImpl implements IFolder.Presenter {
    ...
    public FolderPresenterImpl(IFolder.View view, IRepository repository, BaseSchedulerProvider scheduler) {
        this.view = view;
